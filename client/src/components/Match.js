    ...
    const fetchTime = async () => {
      try {
        ...
        const timeLeftInMilliseconds =
          fifteenMinutesInMilliseconds - differenceInMilliseconds;
        if (timeLeftInMilliseconds <= 0) {
          ...
          const minutesLeft = Math.floor(timeLeftInMilliseconds / (60 * 1000))
            .toString()
            .padStart(2, "0");
          const secondsLeft = Math.floor(
            (timeLeftInMilliseconds % (60 * 1000)) / 1000
          )
            .toString()
            .padStart(2, "0");
  ...
  return (
    ...
    >
      <center>
        ...
        >
          <p>
            Time Left- {minutes}:{seconds} (Time changes every 5 seconds)
          </p>
        </div>
      </center>
      <div
      ...
      >
        ...
        <span style={{ fontSize: "18px", color: "#666", margin: "0 10px" }}>
          vs
        </span>
